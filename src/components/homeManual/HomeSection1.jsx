  ...
  return (
    ...
    <div className= "bg-[#001426] lg:bg-white w-full pt-20 lg:pt-38  px-7 rounded-b-4xl" >
      <div
        ...
        bg-gradient-to-r from-[#001426] lg:from-70% via-blue-[#001426] at-130% to-[#FFFFFF] 
        "
      >
      ...
      <div className="w-full flex flex-col lg:flex-row lg:justify-between items-center mt-3  ">
        <div id="left" className="w-full lg:w-[50%] lg:bg-white  ">
          <div>
            ...
            <p className="w-[89%] md:w-[53%] mt-5Grow text-white lg:text-[#001032] leading-10 tracking-wider  ">
              Get expert-backed support, investor visibility, low-cost services
              and organic audience <br />
              access — all in one system
            </p>

            <button className="mt-11 lg:bg-[#001032] bg-white text-[#12355C] lg:text-white font-medium p-5 px-15 text-xl rounded-sm">
              Get Started
            </button>
          </div>
        ...
        bg-gradient-to-r from-[#001426] from-40% via-blue-[#001426] at-130% to-[#FFFFFF]"
            >
        ...
        <div
          ...
          <img src={"/homeSec1.png"} alt="" className="rounded-sm object-fill h-[870px]  hidden lg:block"  />
          <div className="lg:hidden  relative h-100 w-full ">
            <img src={"/homeSec1.png"} alt="" className="rounded-4xl relative top-0 left-0 w-full h-[350px] object-cover z-10 border border-[#001032]" />
             <img src={"/homeSec1.png"} alt="" className="rounded-4xl relative top-[-270px] left-0 w-full h-[350px] object-cover z-5 border border-[#001032]" />
             <img src={"/homeSec1.png"} alt="" className="rounded-4xl relative top-[-540px] left-0 w-full h-[350px] object-cover z-3 border border-[#001032]" />
             <img src={"/homeSec1.png"} alt="" className="rounded-4xl relative top-[-810px] left-0 w-full h-[350px] object-cover border border-[#001032]" />
     ...
     <div className="flex justify-center items-center gap-2 border-2 border-[#001032]  w-[50%] 
